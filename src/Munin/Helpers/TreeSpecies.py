...
POPULUS_TREMULA_X_TREMULOIDES = TreeName(genus=POPULUS,     species_name="tremula x tremuloides", code="PTXT")
...
class TreeSpecies:
    Sweden = RegionalTreeSpecies("Sweden", allowed_species=[
        PICEA_ABIES,
        FAGUS_SYLVATICA,
        QUERCUS_ROBUR,
        QUERCUS_PETRAEA,
...
def parse_tree_species(species_str: Union[str,TreeName]) -> TreeName:
    ...
    The function normalizes the input string (e.g. "pinus sylvestris") and compares
    it to the lower-case full_name property of the defined species in the chosen region, e.g. TreeSpecies.Sweden.
    """
